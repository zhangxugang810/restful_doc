...
(function($, version)
{
                ...
                var attachIFrame = function()
                  {
                    ...
                    container.prev().css({ width: table.width(), height: container.height(), opacity: 0, position: 'fixed', left: container.css("left"), top: container.css("top") });
                  };
                if (settings.window.expandable)
                {
                  $(document.body).children('div.jPicker.Container').css({zIndex:10});
                  container.css({zIndex:1100});
                }
  ...
  $.fn.jPicker.defaults = /* jPicker defaults - you can change anything in this section (such as the clientPath to your images) without fear of breaking the program */
      ...
      images:
        {
          clientPath: '/core/static/Public/images/', /* Path to image files */
          colorMap:
          {
            width: 256,
            height: 256,
