(function() {
    function o(e) {
        ...
        s = t;
        e && (t[e] || (t[e] = {}), s = t[e]);
        if (!s.define || !s.define.packaged) n.original = s.define,
        s.define = n,
        s.define.packaged = !0;
        if (!s.require || !s.require.packaged) r.original = s.require,
        s.require = i,
...
ace.define("ace/ace", ["require", "exports", "module", "ace/lib/fixoldbrowsers", "ace/lib/dom", "ace/lib/event", "ace/editor", "ace/edit_session", "ace/undomanager", "ace/virtual_renderer", "ace/multi_select", "ace/worker/worker_client", "ace/keyboard/hash_handler", "ace/placeholder", "ace/mode/folding/fold_mode", "ace/theme/textmate", "ace/config"],
function(e, t, n) {
...
function(e, t, n) {
    ...
    RegExp.prototype.exec = function(e) {
        ...
        n,
        a;
        if (typeof e == "string" && t) { ! i && t.length > 1 && u(t, "") > -1 && (a = RegExp(this.source, r.replace.call(o(this), "g", "")), r.replace.call(e.slice(t.index), a,
            function() {
                for (var e = 1; e < arguments.length - 2; e++) arguments[e] === undefined && (t[e] = undefined)
            }));
            if (this._xregexp && this._xregexp.captureNames) for (var f = 1; f < t.length; f++) n = this._xregexp.captureNames[f - 1],
            n && (t[n] = t[f]); ! s && this.global && !t[0].length && this.lastIndex > t.index && this.lastIndex--
        }
        return t
    },
...
function(e, t, n) {
    ...
    Function.prototype.bind || (Function.prototype.bind = function(t) {
        ...
        return n.prototype && (r.prototype = n.prototype, s.prototype = new r, r.prototype = null),
        s
    });
    ...
    p,
    d;
    if (d = f(o, "__defineGetter__")) l = i.bind(o.__defineGetter__),
...
function(e, t, n) {
    function o(e, t, n) {
        var s = 0; ! i.isOpera || "KeyboardEvent" in window || !i.isMac ? s = 0 | (t.ctrlKey ? 1 : 0) | (t.altKey ? 2 : 0) | (t.shiftKey ? 4 : 0) | (t.metaKey ? 8 : 0) : s = 0 | (t.metaKey ? 1 : 0) | (t.altKey ? 2 : 0) | (t.shiftKey ? 4 : 0) | (t.ctrlKey ? 8 : 0);
        if (!i.isMac && u) {
            if (u[91] || u[92]) s |= 8;
            if (u.altGr) {
                if ((3 & s) == 3) return;
        ...
        s & 8 && (n === 91 || n === 93) && (n = 0);
        if (!s && n === 13) if (t.location || t.keyLocation === 3) {
            e(t, s, -n);
    ...
    t.addMouseWheelListener = function(e, n) {
        if ("onmousewheel" in e) {
            var r = 8;
            t.addListener(e, "mousewheel",
            function(e) {
                e.wheelDeltaX !== undefined ? (e.wheelX = -e.wheelDeltaX / r, e.wheelY = -e.wheelDeltaY / r) : (e.wheelX = 0, e.wheelY = -e.wheelDelta / r),
                n(e)
            })
        } else "onwheel" in e ? t.addListener(e, "wheel",
        function(e) {
        ...
        function(e) {
            e.axis && e.axis == e.HORIZONTAL_AXIS ? (e.wheelX = (e.detail || 0) * 5, e.wheelY = 0) : (e.wheelX = 0, e.wheelY = (e.detail || 0) * 5),
            n(e)
        })
    },
    t.addMultiMouseDownListener = function(e, n, r, s) {
        ...
        i.isOldIE && t.addListener(e, "dblclick",
        function(e) {
            o = 2,
            f && clearTimeout(f),
            f = setTimeout(function() {
    ...
    t.addCommandKeyListener = function(e, n) {
        ...
        if (i.isOldGecko || i.isOpera && !("KeyboardEvent" in window)) {
            ...
            u || (u = Object.create(null), r(window, "focus",
            function(e) {
...
function(e, t, n) {
    ...
    y = function(e, t) {
        ...
        this.$updateHighlightActiveLine = function() {
            ...
            if (e.$highlightLineMarker && !t) e.removeMarker(e.$highlightLineMarker.id),
        ...
        this.transposeLetters = function() {
            ...
            r,
            i;
            t < n.length ? (r = n.charAt(t) + n.charAt(t - 1), i = new p(e.row, t - 1, e.row, t + 1)) : (r = n.charAt(t - 1) + n.charAt(t - 2), i = new p(e.row, t - 2, e.row, t)),
        ...
        this.indent = function() {
            ...
            l = s.stringRepeat(" ", f);
                ...
                var f = a % u;
                while (i[t.start.column] == " " && f) t.start.column--,
                f--;
        ...
        this.$moveByPage = function(e, t) {
            ...
            }) : t == 0 && (this.selection.moveCursorBy(i, 0), this.selection.clearSelection()),
            this.$blockScrolling--;
            var s = n.scrollTop;
        ...
        this.jumpToMatching = function(e) {
            ...
            r = n && n.cursor || r,
            r && (e ? n && n.isEqual(this.getSelectionRange()) ? this.clearSelection() : this.selection.selectTo(r.row, r.column) : (this.clearSelection(), this.moveCursorTo(r.row, r.column)))
        },
        ...
        this.find = function(e, t, n) {
            ...
            if (s) return this.revealRange(s, n),
            s;
        ...
        this.setAutoScrollEditorIntoView = function(e) {
            ...
            var s = this.on("changeSelection",
            function() {
                r = !0
            }),
            o = this.renderer.on("beforeRender",
            function() {
                r && (t = n.renderer.container.getBoundingClientRect())
            }),
            u = this.renderer.on("afterRender",
            function() {
                if (r && t && n.isFocused()) {
                    var e = n.renderer,
                    ...
                    r != null && (i.style.top = u + "px", i.style.left = s.left + "px", i.style.height = o.lineHeight + "px", i.scrollIntoView(r)),
                    r = t = null
                }
            });
            this.setAutoScrollEditorIntoView = function(e) {
...
function(e, t, n) {
    ...
    t.copyArray = function(e) {
        var t = [];
        for (var n = 0,
        r = e.length; n < r; n++) e[n] && typeof e[n] == "object" ? t[n] = this.copyObject(e[n]) : t[n] = e[n];
        return t
    },
    ...
    a = function(e, t) {
        ...
        function F() {
            setTimeout(function() {
                ...
                t.renderer.$keepTextAreaAtCursor == null && (t.renderer.$keepTextAreaAtCursor = !0, t.renderer.$moveTextAreaToCursor())
            },
            0)
        }
        ...
        r.addListener(n, "blur",
        function() {
            t.onBlur(),
            v = !1
        }),
        r.addListener(n, "focus",
        function() {
            v = !0,
            t.onFocus(),
            b()
        ...
        i.isWebKit || t.addEventListener("changeSelection",
        function() {
        ...
        A = function(e) {
            k && (e = k(e), k = null),
            c ? (b(), e && t.onPaste(e), c = !1) : e == a.charAt(0) ? L && t.execCommand("del", {
                source: "ace"
            }) : (e.substring(0, 2) == a ? e = e.substr(2) : e.charAt(0) == a.charAt(0) ? e = e.substr(1) : e.charAt(e.length - 1) == a.charAt(0) && (e = e.slice(0, -1)), e.charAt(e.length - 1) == a.charAt(0) && (e = e.slice(0, -1)), e && t.onTextInput(e)),
            L && (L = !1)
        },
        O = function(e) {
            if (h) return;
        ...
        (!("oncut" in n) || !("oncopy" in n) || !("onpaste" in n)) && r.addListener(e, "keydown",
        function(e) {
        ...
        var P = function(e) {
            ...
            setTimeout(H, 0),
            t.on("mousedown", B),
            t.selection.isEmpty() || (t.insert(""), t.session.markUndoGroup(), t.selection.clearSelection()),
        ...
        B = function(e) {
            ...
            k = function(n) {
                ...
                n = n.replace(/\x01/g, ""),
                n == r.lastValue ? "": (r.lastValue && t.undo(), n)
            },
            t.onCompositionEnd(),
        ...
        r.addListener(n, i.isGecko ? "text": "keyup",
        function() {
            j.schedule()
        }),
        ...
        (!i.isGecko || i.isMac) && r.addListener(n, "contextmenu",
        function(e) {
...
ace.define("ace/mouse/mouse_handler", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent", "ace/mouse/default_handlers", "ace/mouse/default_gutter_handler", "ace/mouse/mouse_event", "ace/mouse/dragdrop", "ace/config"],
function(e, t, n) {
    var r = e("../lib/event"),
    i = e("../lib/useragent"),
    ...
    l = function(e) {
        ...
        e.renderer.scrollBarV && (r.addMultiMouseDownListener(e.renderer.scrollBarV.inner, [300, 300, 250], this, "onMouseEvent"), r.addMultiMouseDownListener(e.renderer.scrollBarH.inner, [300, 300, 250], this, "onMouseEvent")),
        ...
        r.addListener(t, "mousedown",
        function(t) {
            return e.focus(),
            r.preventDefault(t)
        }),
        r.addListener(n, "mousedown",
        function(t) {
            return e.focus(),
            r.preventDefault(t)
        })
        ...
        this.captureMouse = function(e, t) {
            ...
            u = function(e) {
                ...
                n.$keepTextAreaAtCursor == null && (n.$keepTextAreaAtCursor = !0, n.$moveTextAreaToCursor()),
                s.isMousePressed = !1,
...
ace.define("ace/mouse/default_handlers", ["require", "exports", "module", "ace/lib/dom", "ace/lib/useragent"],
function(e, t, n) {
    function o(e) {
    ...
    s = 0; (function() {
        this.onMouseDown = function(e) {
            ...
            if (i !== 0) {
                ...
                o = s.isEmpty();
                o && (r.moveCursorToPosition(n), r.selection.clearSelection()),
                r.textInput.onContextMenu(e.domEvent);
                return
            }
            if (t && !r.isFocused()) {
                r.focus();
                if (this.$focusTimout && !this.$clickSelection && !r.inMultiSelectMode) return this.setState("focusWait"),
                this.captureMouse(e),
                e.preventDefault()
            }
            return ! t || this.$clickSelection || e.getShiftKey() || r.inMultiSelectMode ? this.startSelect(n) : t && (this.mousedownEvent.time = (new Date).getTime(), this.setState("dragWait")),
            this.captureMouse(e),
            e.preventDefault()
        },
        this.startSelect = function(e) {
            e = e || this.editor.renderer.screenToTextCoordinates(this.x, this.y),
            this.mousedownEvent.getShiftKey() ? this.editor.selection.selectToPosition(e) : this.$clickSelection || (this.editor.moveCursorToPosition(e), this.editor.selection.clearSelection()),
        ...
        this.focusWait = function() {
            ...
            t = (new Date).getTime(); (e > s || t - this.mousedownEvent.time > this.$focusTimout) && this.startSelect(this.mousedownEvent.getDocumentPosition())
        },
        ...
        this.onMouseWheel = function(e) {
            ...
            if (i || n < 200) return this.$lastScrollTime = t,
...
function(e, t, n) {
    function s(e) {
        ...
        function c() {
            s && (s = clearTimeout(s)),
            a && (u.style.display = "none", a = null, t.removeEventListener("mousewheel", c))
        }
        function h(e) {
            var n = t.renderer.$gutter.getBoundingClientRect();
            u.style.left = e.x + 15 + "px",
            e.y + 3 * t.renderer.lineHeight + 15 < n.bottom ? (u.style.bottom = "", u.style.top = e.y + 15 + "px") : (u.style.top = "", u.style.bottom = n.bottom - e.y + 5 + "px")
        }
        var t = e.editor,
        ...
        function(r) {
            ...
            if (r.getShiftKey()) o.selectTo(s, 0);
                ...
                if (r.domEvent.detail == 2) return t.selectAll(),
                r.preventDefault();
        ...
        i.addListener(t.renderer.$gutter, "mouseout",
        function(e) {
            o = null;
            if (!a || s) return;
            s = setTimeout(function() {
...
ace.define("ace/mouse/dragdrop", ["require", "exports", "module", "ace/lib/event"],
function(e, t, n) {
    var r = e("../lib/event"),
    i = function(e) {
        function h() {
        ...
        r.addListener(l, "dragleave",
        function(e) {
            f--;
            if (f <= 0 && n) return p(),
            r.preventDefault(e)
        }),
        r.addListener(l, "drop",
        function(e) {
            if (!n) return;
...
function(e, t, n) {
    ...
    t.init = function() {
        ...
        i && (r.base = r.base || i, r.packaged = !0),
        r.basePath = r.base,
...
function(e, t, n) {
    ...
    t.loadScript = function(e, t) {
        ...
        i.onload = i.onreadystatechange = function(e, n) {
            if (n || !i.readyState || i.readyState == "loaded" || i.readyState == "complete") i = i.onload = i.onreadystatechange = null,
            n || t()
        }
    }
}),
...
function(e, t, n) {
    ...
    p = function(e, t) {
        ...
        this.onChange = function(e) {
            ...
            var n = this.$updateInternalDataOnChange(e); ! this.$fromUndo && this.$undoManager && !t.ignore && (this.$deltasDoc.push(t), n && n.length != 0 && this.$deltasFold.push({
                action: "removeFolds",
                folds: n
        ...
        this.addMarker = function(e, t, n, r) {
            ...
            return r ? (this.$frontMarkers[i] = s, this._emit("changeFrontMarker")) : (this.$backMarkers[i] = s, this._emit("changeBackMarker")),
            i
        },
        this.addDynamicMarker = function(e, t) {
            ...
            return e.id = n,
            e.inFront = !!t,
            t ? (this.$frontMarkers[n] = e, this._emit("changeFrontMarker")) : (this.$backMarkers[n] = e, this._emit("changeBackMarker")),
            e
        },
        ...
        this.setMode = function(e, t) {
            ...
            function(e) {
                ...
                if (this.$modes[r] && !n) return this.$onChangeMode(this.$modes[r]);
                e && e.Mode && (e = new e.Mode(n), n || (this.$modes[r] = e, e.$id = r), this.$onChangeMode(e), t && t(this.mode))
            }.bind(this)),
        ...
        this.$onChangeMode = function(e, t) {
            ...
            t || (this.$setFolding(e.foldingRules), this._emit("changeMode"), this.bgTokenizer.start(0))
        },
        ...
        this.$getUndoSelection = function(e, t, n) {
            ...
            for (var a = 1; a < e.length; a++) i = e[a],
            r(i) ? (o = i.range.start, s.compare(o.row, o.column) == -1 && s.setStart(i.range.start), o = i.range.end, s.compare(o.row, o.column) == 1 && s.setEnd(i.range.end), u = !0) : (o = i.range.start, s.compare(o.row, o.column) == -1 && (s = f.fromPoints(i.range.start, i.range.start)), u = !1);
            if (n != null) {
        ...
        this.moveText = function(e, t, n) {
            ...
            if (!n) {
                ...
                u && (s.start.row == e.end.row && s.start.column > e.end.column && (s.start.column += u), s.end.row == e.end.row && s.end.column > e.end.column && (s.end.column += u)),
        ...
        this.outdentRows = function(e) {
            ...
            for (var i = t.start.row; i <= t.end.row; ++i) {
                ...
                o < r && s.charAt(o) == "	" ? (n.start.column = o, n.end.column = o + 1) : (n.start.column = 0, n.end.column = o),
                this.remove(n)
            }
        },
        ...
        this.$updateInternalDataOnChange = function(e) {
            ...
            if (n != 0) if (r.indexOf("remove") != -1) {
                ...
                if (l) {
                    ...
                    v == 0 ? (l = l.split(o.row, o.column), l.shiftRow(n), l.addRemoveChars(s, 0, u.column - o.column)) : v == -1 && (l.addRemoveChars(i, 0, u.column - o.column), l.shiftRow(n)),
                    c = f.indexOf(l) + 1
                }
                for (c; c < f.length; c++) {
                    var l = f[c];
                ...
                r.indexOf("remove") != -1 && (a = this.getFoldsInRange(e.data.range), this.removeFolds(a), n = -n);
        ...
        this.$updateWrapData = function(e, t) {
            ...
            while (f <= t) a = this.getFoldLine(f, a),
            a ? (o = [], a.walk(function(e, t, r, i) {
                var s;
                if (e != null) {
        ...
        this.screenToDocumentPosition = function(e, t) {
            ...
            while (o <= e) {
                ...
                o += u,
                r++,
                r > d && (r = p.end.row + 1, p = this.getNextFoldLine(r, p), d = p ? p.start.row: Infinity),
                c && (this.$docRowCache.push(r), this.$screenRowCache.push(o))
            }
            if (p && p.start.row <= r) n = this.getFoldDisplayLine(p),
            r = p.start.row;
            else {
                if (o + u <= e || r > h) return {
                    row: h,
        ...
        this.getScreenLength = function() {
            ...
            if (!this.$useWrapMode) {
                ...
                while (s < i) e += this.$wrapData[s].length + 1,
                s++,
    ...
    s.defineOptions(p.prototype, "session", {
        wrap: {
            set: function(e) { ! e || e == "off" ? e = !1 : e == "free" ? e = !0 : e == "printMargin" ? e = -1 : typeof e == "string" && (e = parseInt(e, 10) || !1);
...
function(e, t, n) {
    ...
    u = function(e) {
        ...
        this.shiftSelection = function(e) {
            ...
            r = this.isBackwards(); (!r || t.column !== 0) && this.setSelectionAnchor(t.row, t.column + e),
        ...
        this.getLineRange = function(e, t) {
            ...
            return i ? (n = i.start.row, r = i.end.row) : r = n,
        ...
        this.moveCursorLongWordRight = function() {
            ...
            if (i = this.session.nonTokenRe.exec(r)) t += this.session.nonTokenRe.lastIndex,
            this.session.nonTokenRe.lastIndex = 0,
            r = n.substring(t);
            if (t >= n.length) {
            ...
            if (i = this.session.tokenRe.exec(r)) t += this.session.tokenRe.lastIndex,
            this.session.tokenRe.lastIndex = 0;
            this.moveCursorTo(e, t)
        },
        this.moveCursorLongWordLeft = function() {
            ...
            if (o = this.session.tokenRe.exec(s)) t -= this.session.tokenRe.lastIndex,
            this.session.tokenRe.lastIndex = 0;
            this.moveCursorTo(e, t)
        },
...
function(e, t, n) {
    ...
    i = function(e, t, n, r) {
        ...
        this.compareRange = function(e) {
            ...
            t == 1 ? (t = this.compare(r.row, r.column), t == 1 ? 2 : t == 0 ? 1 : 0) : t == -1 ? -2 : (t = this.compare(r.row, r.column), t == -1 ? -1 : t == 1 ? 42 : 0)
        },
    ...
    l = function() {
        ...
        this.toggleCommentLines = function(e, t, n, r) {
            ...
            if (!this.lineCommentStart) {
                ...
                m = function(e, t) {
                    var n; (n = e.match(d)) && i.removeInLine(t, e.length - n[0].length, e.length),
                ...
                var m = function(e, t) {
                    ...
                    if (!n) return;
                    var r = n[1].length,
                    s = n[0].length; ! b(e, r, s) && n[0][s - 1] == " " && s--,
        ...
        this.getKeywords = function(e) {
            if (!this.completionKeywords) {
                ...
                for (var r in t) {
                    var i = t[r];
                    for (var s = 0,
                    o = i.length; s < o; s++) if (typeof i[s].token == "string") / keyword | support | storage / .test(i[s].token) && n.push(i[s].regex);
                    else if (typeof i[s].token == "object") for (var u = 0,
                    a = i[s].token.length; u < a; u++) if (/keyword|support|storage/.test(i[s].token[u])) {
    ...
    i = function(e) {
        ...
        for (var t in this.states) {
            ...
            for (var a = 0; a < n.length; a++) {
                ...
                if (Array.isArray(f.token)) if (f.token.length == 1 || c == 1) f.token = f.token[0];
                else {
                ...
                c > 1 && (/\\\d/.test(f.regex) ? l = f.regex.replace(/\\([0-9]+)/g,
                function(e, t) {
        ...
        this.$applyToken = function(e) {
            ...
            var r = [];
            for (var i = 0,
            s = n.length; i < s; i++) t[i] && (r[r.length] = {
                type: n[i],
                value: t[i]
            });
            return r
        ...
        this.$arrayTokens = function(e) {
            ...
            r = this.tokenArray;
            for (var i = 0,
            s = r.length; i < s; i++) t[i + 1] && (n[n.length] = {
                type: r[i],
                value: t[i + 1]
            });
            return n
        ...
        this.createSplitterRegexp = function(e, t) {
            if (e.indexOf("(?=") != -1) {
                ...
                function(e, t, s, o, u, a) {
                    return r ? r = u != "]": u ? r = !0 : o ? (n == i.stack && (i.end = a + 1, i.stack = -1), n--) : s && (n++, s.length != 1 && (i.stack = n, i.start = a)),
                    e
                }),
        ...
        this.getLineTokens = function(e, t) {
            ...
            while (a = u.exec(e)) {
                ...
                for (var g = 0; g < a.length - 2; g++) {
                    ...
                    p.next && (typeof p.next == "string" ? i = p.next: i = p.next(i, n), s = this.states[i], s || (window.console && console.error && console.error(i, "doesn't exist"), i = "start", s = this.states[i]), o = this.matchMappings[i], l = v, u = this.regExps[i], u.lastIndex = v);
                    break
                }
                ...
                l = v;
                if (f.length > r) {
                    while (l < e.length) c.type && f.push(c),
                    c = {
        ...
        this.normalizeRules = function() {
            function i(s) {
                ...
                for (var u = 0; u < o.length; u++) {
                    var a = o[u]; ! a.regex && a.start && (a.regex = a.start, a.next || (a.next = []), a.next.push({
    ...
    var r = function(e, t, n) {
        ...
        this.stepBackward = function() {
            ...
            while (this.$tokenIndex < 0) {
                this.$row -= 1;
                if (this.$row < 0) return this.$row = 0,
                null;
        ...
        this.stepForward = function() {
            ...
            while (this.$tokenIndex >= this.$rowTokens.length) {
                ...
                if (this.$row >= e) return this.$row = e - 1,
                null;
                this.$rowTokens = this.$session.getTokens(this.$row),
                this.$tokenIndex = 0
            }
...
function(e, t, n) {
    ...
    u = function(e) {
        ...
        this.insert = function(e, t) {
            ...
            i !== null && (e = this.insertNewLine(e), e = this._insertLines(e.row, n), e = this.insertInLine(e, i || "")),
            e
        },
        ...
        this.remove = function(e) { ! e instanceof s && (e = s.fromPoints(e.start, e.end)),
            ...
            if (e.isMultiLine()) {
                ...
                r != t && (this.removeInLine(t, e.start.column, this.getLine(t).length), this.removeNewLine(e.start.row))
        ...
        this.replace = function(e, t) { ! e instanceof s && (e = s.fromPoints(e.start, e.end));
...
function(e, t, n) {
    ...
    s = t.Anchor = function(e, t, n) {
        ...
        this.$clipPositionToDocument = function(e, t) {
            var n = {};
            return e >= this.document.getLength() ? (n.row = Math.max(0, this.document.getLength() - 1), n.column = this.document.getLine(n.row).length) : e < 0 ? (n.row = 0, n.column = 0) : (n.row = e, n.column = Math.min(this.document.getLine(n.row).length, Math.max(0, t))),
            t < 0 && (n.column = 0),
            n
        }
    }).call(s.prototype)
...
function(e, t, n) {
    ...
    s = function(e, t) {
        ...
        this.$updateOnChange = function(e) {
            ...
            else if (e.action == "removeText" || e.action == "removeLines") this.lines.splice(n, r + 1, null),
        ...
        this.$tokenizeRow = function(e) {
            ...
            return this.states[e] + "" != r.state + "" ? (this.states[e] = r.state, this.lines[e + 1] = null, this.currentLine > e + 1 && (this.currentLine = e + 1)) : this.currentLine == e && (this.currentLine = e + 1),
...
function(e, t, n) {
    function u() {
        ...
        this.removeFold = function(e) {
            ...
            else if (t.range.isEnd(e.end.row, e.end.column)) s.pop(),
            t.end.row = s[s.length - 1].end.row,
            t.end.column = s[s.length - 1].end.column;
            else if (t.range.isStart(e.start.row, e.start.column)) s.shift(),
        ...
        this.unfold = function(e, t) {
            var n, i;
            e == null ? (n = new r(0, 0, this.getLength(), 0), t = !0) : typeof e == "number" ? n = new r(e, 0, e, this.getLine(e).length) : "row" in e ? n = r.fromPoints(e, e) : n = e,
            i = this.getFoldsInRange(n);
            if (t) this.removeFolds(i);
            else while (i.length) this.expandFolds(i),
            i = this.getFoldsInRange(n)
        },
        ...
        this.getFoldDisplayLine = function(e, t, n, r, i) {
            r == null && (r = e.start.row, i = 0),
            t == null && (t = e.end.row, n = this.getLine(t).length);
            var s = this.doc,
            o = "";
        ...
        this.foldAll = function(e, t, n) {
            ...
            for (var i = e; i < t; i++) {
                ...
                o = s.end.row;
                if (s && s.isMultiLine() && o <= t && s.start.row >= e) try {
                    var u = this.addFold("...", s);
                    u.collapseChildren = n,
                    i = o
                } catch(a) {}
            }
        },
        ...
        this.$onChange = function(e) {
            ...
            l = a.length; f < l; f++) {
                ...
                if (c.end.row == i && c.end.column >= n.column) {
                    ...
                    c.end.column == n.column && u > 0 && f < l - 1 && c.end.column > c.start.column && c.end.column == a[f + 1].start.column && (c.end.column -= u),
                    c.end.column += u,
                    c.end.row += o
                }
            }
    ...
    o = function() {
        ...
        this.findAll = function(e) {
            ...
            if (n) {
                ...
                o = o.slice(m, c + 1);
                for (m = 0, c = o.length; m < c; m++) o[m].start.row += n.start.row,
        ...
        this.$assembleMultilineRegExp = function(e, t) {
            ...
            return n[0] == "" ? (r.shift(), r.offset = 1) : r.offset = 0,
            r
        },
...
function(e, t, n) {
    ...
    function() {
        ...
        this.toggleRecording = function(e) {
            ...
            this.recording ? (this.macro.pop(), this.removeEventListener("exec", this.$addCommandToMacro), this.macro.length || (this.macro = this.oldMacro), this.recording = !1) : (this.$addCommandToMacro || (this.$addCommandToMacro = function(e) {
    ...
    i = e("../lib/useragent"); (function() {
        ...
        this.parseKeys = function(e) {
            ...
            for (var o = t.length; o--;) {
                ...
                if (u == null) return typeof console != "undefined" && console.error("invalid modifier " + t[o] + " in " + e),
                !1;
                s |= u
            }
            return {
...
function(e, t, n) {
    ...
    t.commands = [{
        ...
        exec: function(e) {
            i.loadModule("ace/ext/settings_menu",
            function(t) {
                t.init(e),
                e.showSettingsMenu()
            })
    ...
    },
    {
        ...
        exec: function(e) {
            i.loadModule("ace/ext/searchbox",
            function(t) {
                t.Search(e)
            })
        },
...
function(e, t, n) {
    ...
    var m = function(e, t) {
        ...
        this.$updateCachedSize = function(e, t, n, r) {
            ...
            r && (e || s.height != r) && (s.height = r, i = this.CHANGE_SIZE, s.scrollerHeight = s.height, this.$horizScroll && (s.scrollerHeight -= this.scrollBarH.getHeight()), this.scrollBarV.element.style.bottom = this.scrollBarH.getHeight() + "px", this.session && (this.session.setScrollTop(this.getScrollTop()), i |= this.CHANGE_SCROLL));
            if (n && (e || s.width != n)) {
                i = this.CHANGE_SIZE,
                s.width = n,
            ...
            return i && this._signal("resize", o),
            i
        },
        this.onGutterResize = function() {
            ...
            this.session.getUseWrapMode() && this.adjustWrapLimit() ? this.$loop.schedule(this.CHANGE_FULL) : (this.$computeLayerConfig(), this.$loop.schedule(this.CHANGE_MARKER))
        },
        ...
        this.$renderChanges = function(e, t) {
            ...
            if (!this.$size.width) return this.$changes |= e,
            this.onResize(!0);
            ...
            e & this.CHANGE_CURSOR && (this.$cursorLayer.update(this.layerConfig), this.$moveTextAreaToCursor(), this.$highlightGutterLine && this.$updateGutterLineHighlight()),
            ...
            if (e & this.CHANGE_SIZE || e & this.CHANGE_LINES) this.$updateScrollBarV(),
            this.$updateScrollBarH();
            this._signal("afterRender")
        },
        ...
        this.$computeLayerConfig = function() {
            ...
            a && (this.$horizScroll = u, this.scrollBarH.setVisible(u)),
            ...
            l = this.$vScroll !== f;
            l && (this.$vScroll = f, this.scrollBarV.setVisible(f)),
            ...
            h = Math.max(0, Math.round((this.scrollTop - i) / this.lineHeight)),
            p = h + c,
            d,
            v,
            m = this.lineHeight;
            ...
            var y = 0;
            if (a || l) y = this.$updateCachedSize(!0, this.gutterWidth, this.$size.width, this.$size.height),
        ...
        this.setTheme = function(e, t) {
            function s(r) {
                ...
                n.$size && (n.$size.width = 0, n.onResize()),
    ...
    o.defineOptions(m.prototype, "renderer", {
        ...
        hScrollBarAlwaysVisible: {
            set: function(e) { (!this.$hScrollBarAlwaysVisible || !this.$horizScroll) && this.$loop.schedule(this.CHANGE_SCROLL)
            },
            initialValue: !1
        },
        vScrollBarAlwaysVisible: {
            set: function(e) { (!this.$vScrollBarAlwaysVisible || !this.$vScroll) && this.$loop.schedule(this.CHANGE_SCROLL)
            },
            initialValue: !1
        },
        fontSize: {
...
function(e, t, n) {
    ...
    u = function(e) {
        ...
        this.$updateAnnotations = function(e) {
            ...
            r = n.start.row,
            i = n.end.row - r;
            if (i !== 0) if (t.action == "removeText" || t.action == "removeLines") this.$annotations.splice(r, i + 1, null);
            else {
                var s = Array(i + 1);
                s.unshift(r, 1),
        ...
        this.update = function(e) {
            var t = e.firstRow,
            n = e.lastRow,
            i = this.session.getNextFoldLine(t),
            s = i ? i.start.row: Infinity,
            o = this.$showFoldWidgets && this.session.foldWidgets,
            u = this.session.$breakpoints,
            a = this.session.$decorations,
            f = this.session.$firstLineNumber,
            l = 0,
            c = null,
            h = -1,
            p = t;
            for (;;) {
                p > s && (p = i.end.row + 1, i = this.session.getNextFoldLine(p, i), s = i ? i.start.row: Infinity);
                if (p > n) {
                    while (this.$cells.length > h + 1) c = this.$cells.pop(),
                ...
                c.element = r.createElement("div"), c.textNode = document.createTextNode(""), c.element.appendChild(c.textNode), this.element.appendChild(c.element), this.$cells[h] = c);
                var d = "ace_gutter-cell";
                u[p] && (d += u[p]),
                a[p] && (d += a[p]),
                this.$annotations[p] && (d += this.$annotations[p].className),
                c.element.className != d && (c.element.className = d);
                var v = this.session.getRowLength(p) * e.lineHeight + "px";
                v != c.element.style.height && (c.element.style.height = v);
                var m = l = p + f;
                m != c.textNode.data && (c.textNode.data = m);
                if (o) {
                    var g = o[p];
                    g == null && (g = o[p] = this.session.getFoldWidget(p))
                }
                if (g) {
                    c.foldWidget || (c.foldWidget = r.createElement("span"), c.element.appendChild(c.foldWidget));
                    var d = "ace_fold-widget ace_" + g;
                    g == "start" && p == s && p < i.end.row ? d += " ace_closed": d += " ace_open",
                    c.foldWidget.className != d && (c.foldWidget.className = d);
                    var v = e.lineHeight + "px";
                    c.foldWidget.style.height != v && (c.foldWidget.style.height = v)
                } else c.foldWidget != null && (c.element.removeChild(c.foldWidget), c.foldWidget = null);
                p++
            }
            this.element.style.height = e.minHeight + "px";
            if (this.$fixedWidth || this.session.$useWrapMode) l = this.session.getLength();
            var y = l.toString().length * e.characterWidth,
            b = this.$padding || this.$computePadding();
            y += b.left + b.right,
            y !== this.gutterWidth && !isNaN(y) && (this.gutterWidth = y, this.element.style.width = Math.ceil(this.gutterWidth) + "px", this._emit("changeGutterWidth", y))
        },
        this.$fixedWidth = !1,
...
function(e, t, n) {
    ...
    s = function(e) {
        ...
        this.drawTextMarker = function(e, t, n, i, s) {
            ...
            for (o = t.start.row + 1; o < t.end.row; o++) u.start.row = o,
            u.end.row = o,
...
function(e, t, n) {
    ...
    a = function(e) {
        ...
        this.updateLines = function(e, t, n) { (this.config.lastRow != e.lastRow || this.config.firstRow != e.firstRow) && this.scrollLines(e),
            this.config = e;
        ...
        this.$renderLinesFragment = function(e, t, n) {
            ...
            for (;;) {
                ...
                a.innerHTML = f.join("");
                if (this.$useLineGroups()) a.className = "ace_line_group",
                r.appendChild(a);
                else {
                    var l = a.childNodes;
        ...
        this.$renderWrappedLine = function(e, t, n, r) {
            ...
            for (var a = 0; a < t.length; a++) {
                ...
                if (a == 0 && this.displayIndentGuides) {
                    i = l.length,
                    l = this.renderIndentGuide(e, l, o);
                    if (!l) continue;
                    i -= l.length
                }
                if (i + l.length < o) u = this.$renderToken(e, u, f, l),
                i += l.length;
                else {
                    while (i + l.length >= o) u = this.$renderToken(e, u, f, l.substring(0, o - i)),
                    l = l.substring(o - i),
                    i = o,
        ...
        this.$renderSimpleLine = function(e, t) {
            ...
            for (var s = 1; s < t.length; s++) r = t[s],
            i = r.value,
            n = this.$renderToken(e, n, r, i)
        },
        this.$renderLine = function(e, t, n, r) { ! r && r != 0 && (r = this.session.getFoldLine(t));
            ...
            this.showInvisibles && (r && (t = r.end.row), e.push("<span class='ace_invisible'>", t == this.session.getLength() - 1 ? this.EOF_CHAR: this.EOL_CHAR, "</span>")),
            n || e.push("</div>")
        },
...
function(e, t, n) {
    ...
    function() {
        ...
        this.addRange = function(e, t) {
            ...
            if (!this.inMultiSelectMode && this.rangeCount == 0) {
                ...
                if (this.rangeList.ranges.length != 2) return this.rangeList.removeAll(),
        ...
        this.substractPoint = function(e) {
            ...
            if (t) return this.$onRemoveRange(t),
            t[0]
        },
        ...
        this.$onRemoveRange = function(e) {
            ...
            this.rangeCount == 0 && this.inMultiSelectMode && (this.inMultiSelectMode = !1, this._emit("singleSelect"), this.session.$undoSelect = !0, this.rangeList.detach(this.session)),
            t = t || this.ranges[0],
    ...
    var d = e("./editor").Editor; (function() {
        ...
        this.forEachSelection = function(e, t, n) {
            ...
            for (var l = o.ranges.length; l--;) {
                ...
                var c = e.exec(this, t || {}); ! u == undefined && (u = c),
        ...
        this.selectMore = function(e, t) {
            ...
            o = h(n, s, e);
            o && (o.cursor = e == -1 ? o.start: o.end, this.multiSelect.addRange(o)),
    ...
    t.onSessionChange = function(e) {
        ...
        var n = e.oldSession;
        n && (n.multiSelect.removeEventListener("addRange", this.$onAddRange), n.multiSelect.removeEventListener("removeRange", this.$onRemoveRange), n.multiSelect.removeEventListener("multiSelect", this.$onMultiSelect), n.multiSelect.removeEventListener("singleSelect", this.$onSingleSelect)),
    ...
    e("./config").defineOptions(d.prototype, "editor", {
        enableMultiselect: {
            set: function(e) {
                m(this),
                e ? (this.on("changeSession", this.$multiselectOnSessionChange), this.on("mousedown", o)) : (this.off("changeSession", this.$multiselectOnSessionChange), this.off("mousedown", o))
            },
            value: !0
        }
    })
...
function(e, t, n) {
    ...
    o = function(t, n, r) {
        ...
        var i;
        if (s.get("packaged") || !e.toUrl) i = s.moduleUrl(n, "worker");
        else {
