                ...
                elements: [{
                    ...
                    children: [{
                        ...
                        },
                        {
                            ...
                            onClick: function(){
                                var tdialog = this.getDialog();
                                var txtObj= tdialog.getContentElement('info','src');
                                var txtId = txtObj.getInputElement().$.id;
                                var prev = tdialog.getContentElement("info", "preview");
                                var pId = prev.getElement().getChild(3).$.id;
                                this.callback = txtId;
                                this.iseditor = pId+':FLASH';
                                uploadPic($(this))
                            }
                        }
                        /*{
